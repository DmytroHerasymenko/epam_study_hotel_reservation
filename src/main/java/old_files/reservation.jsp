...
<form action="./reservation_handler" method="post">
    ...
    <label>
        ...
        <span >
            Standard-single - <%=session.getAttribute("stSingle")%>$/night. Select rooms:

            <input type="hidden" name="st_single_id" value="${roomType}" />
        ...
        <span >
            Standard-double - <%=session.getAttribute("stDouble")%>$/night. Select rooms:
        ...
        <span >
            Standard-twin - <%=session.getAttribute("stTwin")%>$/night. Select rooms:
        ...
        <p align="center" style="display:none">
        <span>
            Suite-double - <%=session.getAttribute("suDouble")%>$/night. Select rooms:
            ...
            <br/>
        <span>
            Suite-twin - <%=session.getAttribute("suTwin")%>$/night. Select rooms:
        ...
        <p align="center" style="display:none">
        <span align="center">
            Deluxe-double - <%=session.getAttribute("deDouble")%>$/night. Select rooms:
